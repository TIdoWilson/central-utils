...
### Sintoma
Ao enviar Excel + PDF Itaú, o site retornava 500 mesmo com os arquivos válidos.

### Causa provavel
A API Python ainda não recebia `conta_corrente_1` e `conta_corrente_2` no contrato do endpoint, então o core rejeitava o processamento do PDF Itaú.

### Solucao
O endpoint `/api/gfbr-gerador-txt/processar` agora aceita e repassa as contas correntes dos PDFs Itaú para o core, alinhando o contrato com a rota Node e com o front.
