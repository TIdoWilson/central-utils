...
- **Extrator ZIP RAR** — `/extrator-zip-rar` • API: `/api/extrator-zip-rar`
- **Formatador Bernardina** — `/formatador-bernardina` • API: `/api/formatador-bernardina`
- **Gerador Atas** — `/gerador-atas` • API: `/api/gerador-atas`
- **Importador Recebimentos Madre SCP** — `/importador-recebimentos-madre-scp` • API: `/api/importador-recebimentos-madre-scp`
- **IRPF** — `/irpf` • API: `/api/irpf`
- **IRPF Carne Leao** — `/irpf-carne-leao`
- **MIT** — `/mit` • API: `/api/mit`
- **NFE** — `/nfe`
