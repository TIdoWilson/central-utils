...
const TOOL_ICON_MAP = {
  ...
  'xml-faenello': buildMonoIcon('mdi:file-document-outline'),
    'calculadora-icms-st': buildMonoIcon('mdi:calculator-variant'),
    'comparador-fsist-sped': buildMonoIcon('mdi:file-compare'),
    speds: buildMonoIcon('mdi:file-cog-outline'),
    'extrator-fiscal-sped': buildMonoIcon('mdi:file-excel-box-outline'),
